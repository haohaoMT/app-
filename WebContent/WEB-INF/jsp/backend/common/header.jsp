...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/jquery-1.8.3.min.js"></script>
    <!-- Bootstrap -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="${pageContext.request.contextPath }/manager/logout"><i class="fa fa-sign-out pull-right"></i>登出</a></li>
                    <li><a href="${pageContext.request.contextPath }/manager/logoutIndex"><i class="fa fa-sign-out pull-right"></i>平台切换</a></li>
                  </ul>
                </li>
