...
<%@include file="common/header.jsp"%>
	...
	<script type="text/javascript">
		$(function(){
			var currentPage=${requestScope.pages.currentPageNo };
			var pageCount=${requestScope.pages.totalPageCount };
			$("#paging").pagination({
...
<div class="row">
	...
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="list" id="select" >
					<!-- <input type="hidden" name="pageIndex" value="1" /> -->
					<input id="currentPage" name="pageIndex" value="1" type="hidden"/>
			    <ul>
					<li>
						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
							...
							<tbody>
								<c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
									...
									<tr>
										<td colspan="9" align="center"><div id="paging"></div></td>
									</tr>
							</tbody>
						</table>
