							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> APP账户管理 <span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/dev/add/addDevUser">APP开发者账户申请</a>
										</li>
										<li><a href="${pageContext.request.contextPath }/dev/update/updateDevUser">个人账户信息维护</a>
										</li>
									</ul></li>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									...
									<li><a
										href="${pageContext.request.contextPath }/dev/logoutIndex"><i
											class="fa fa-sign-out pull-right"></i>平台切换</a>
									</li>
								</ul></li>
